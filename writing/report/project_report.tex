...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item [4. ] If you would like to collect data manually, do the following:
        ...
        \item [5. ] If you would not like to collect data manually, you can download it from \url{https://send.utoronto.ca}, which expires on December 27.\\
        Claim ID: 6PPMsHQNTV7TJRmu\\
        Claim Passcode: 9VPba4YiYx2cetbU\\
        Alternatively, you can download it from \url{https://csc110.hydev.org/processed-data.7z}\\
        ...
        The file \verb|src/utils.py| contains a more detailed directory tree.
        
        \item [6. ] Run \verb|src/main.py|, either in PyCharm or with \texttt{python3 src/main.py}.
